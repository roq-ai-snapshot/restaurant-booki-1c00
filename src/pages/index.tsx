  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Restaurant Booking Engine - Streamlining Your Dining Experience. Reserve, Dine, and Enjoy while We Manage the Details for You."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Booking Engine - Streamlining Your Dining Experience. Reserve, Dine, and Enjoy while We Manage the Details for You.`}
            </Text>
            <Box
